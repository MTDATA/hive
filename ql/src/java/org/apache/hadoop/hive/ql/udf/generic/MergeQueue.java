...
public class MergeQueue<T extends Comparable> {
  ...
  public MergeQueue(T[] heap, int maxSize) {
    initialize(maxSize);
  ...
  public MergeQueue merge(MergeQueue<T> other) {
    int i = 0;
    T t;
    while ((t = other.pop()) != null && i++ < this.maxSize) {
      this.insert(t);
    }
    return this;
  }
